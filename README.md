...
- <b> В отелях, у каждого отеля есть массив фотографий, каждый элемент которого представлен в виде url на фотографию на первом сервере_url на фотографию на втором_ урл на фотографию на 3. Если надо достать картинку, достаем из бд, сплитим по _ и будем round robinом ходить по серверам </b> 
...
#### Распределение машин по дата-центрам
Таким образом распределение будет такое:
7 nginx, 3 машины для сервисов, 9 машин для баз данных, 8 для изображений в каждом из двух датацентров.
